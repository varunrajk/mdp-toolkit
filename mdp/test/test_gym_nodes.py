...
def test_gym_nodes():
    ...
    a = mdp.numx.array([[0], [0], [1]])
    out = gym_node(a)
    assert_array_equal(out[:,gym_node.state_dim*2:gym_node.state_dim*2+gym_node.action_dim], a)
    assert (out.shape[1] == gym_node.state_dim*2+gym_node.action_dim+1+1)
